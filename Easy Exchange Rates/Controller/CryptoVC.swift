...
//    
//    cell.configeureCell(currencyName: currencyArray[indexPath.row].code, currencyDescription: currencyArray[indexPath.row].description, currencyRate: "<#String#>", currencyImage: currencyArray[indexPath.row].image)
//    return cell
//  }
